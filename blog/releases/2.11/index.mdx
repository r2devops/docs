---
title: 2.11 Release
description: R2Devops 2.11 release introduces GitLab CI/CD Catalog Components compliance, custom AI model configuration, enhanced issue remediation, and project analysis.
...
**We are excited to announce R2Devops 2.11! This release brings pipeline composition compliance with GitLab CI/CD Catalog Components, custom AI model configuration, enhanced issue remediation capabilities, and a project analysis page.**
