...
title: 2.7 Release
description: R2Devops 2.7 released includes the abilities to schedule automatic analysis, compliance control over merge request approval, and an improved analysis issues experience.
