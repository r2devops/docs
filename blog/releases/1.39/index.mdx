...
If a project is non-compliant with its compliance composition policy, you can now list the candidate templates to resolve the non-compliant projects. This feature allows you to easily identify the templates that can be applied to bring projects into compliance.
