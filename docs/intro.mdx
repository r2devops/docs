...
<section className="row list_node_modules-@docusaurus-theme-classic-lib-theme-DocCategoryGeneratedIndexPage-styles-module">
  <article className="col col--6 margin-bottom--lg">
    <a
      ...
      alt="To self-managed R2Devops platform documentation"
      href="./self-managed/"
    >
  ...
  <article className="col col--6 margin-bottom--lg">
    <a
      className="card padding--lg cardContainer_node_modules-@docusaurus-theme-classic-lib-theme-DocCard-styles-module"
      alt="To dashboard documentation"
  ...
  <article className="col col--6 margin-bottom--lg">
    <a
      className="card padding--lg cardContainer_node_modules-@docusaurus-theme-classic-lib-theme-DocCard-styles-module"
      alt="To manage templates documentation"
      href="/docs/marketplace/manage-templates"
    >
  ...
  <article className="col col--6 margin-bottom--lg">
    <a
      className="card padding--lg cardContainer_node_modules-@docusaurus-theme-classic-lib-theme-DocCard-styles-module"
      alt="To ambassador program documentation"
      href="./ambassador/"
    >
...
- <a
    alt="Join R2Devops.io Discord"
    href="https://discord.r2devops.io?utm_medium=website&utm_source=r2devopsdocumentation&utm_campaign=homepage"
    target="_blank"
  >
    Join us on Discord
  </a>
