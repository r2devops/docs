...
You can pick one of yours or use a [GitLab template project](https://gitlab.com/projects/new#create_from_template). To simulate the GitLab template that will run on your project, there are several way to do it :
    ...
    3. By remoting your template
      ...
      **OR**
      ...
      After the merge request approval, you can remote it directly from the hub, check the [quick use section](/official-templates/use-templates).
...
:::note 
👉 You can customize it with [variables](/official-templates/contribute/#variables)
:::
...
[customized](/official-templates/use-templates/#templates-customization) by users.
:::
