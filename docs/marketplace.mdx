...
2. In this repository:
    1. Create [R2 file](#template-r2-file)
    2. Create [CI/CD configuration](#template-cicd-conf)
    3. *(optional)* Create [documentation file](#template-documentation)
    4. *(optional)* Setup [versioning](#template-versioning)
    5. *(optional)* Create [changelog file](#template-changelog)
3. Login on R2Devops
...
-  [R2Devops guidelines and best
   practices](/official-templates/contribute/#guidelines-required) about job definition.
...
add the template
[template_release](https://r2devops.io/marketplace/gitlab/r2devops/hub/template_release) in your
